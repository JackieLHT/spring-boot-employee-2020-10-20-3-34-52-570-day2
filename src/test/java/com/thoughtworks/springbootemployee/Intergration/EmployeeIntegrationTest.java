...
public class EmployeeIntegrationTest {
    ...
    @Test
    public void should_throw_EmployeeNotFoundException_when_get_by_id_given_invalid_employee_id() throws Exception {
        //given
        Employee employee = new Employee("David", 18, "male", 10000);
        employeeRepository.save(employee);
        //when
        //then
        mockMvc.perform(get("/employees/" + "5fc8829e3bf5ed6bcd35a290"))
                .andExpect(status().isNotFound())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof EmployeeNotFoundException))
                .andExpect(result -> assertEquals("Employee Id does not exist", result.getResolvedException().getMessage()));
    }
    ...
    @Test
    public void should_update_employee_when_update_given_valid_employee_id_and_employeeUpdate_info() throws Exception {
        //given
        Employee employee1 = new Employee("David", 18, "male", 10000);
        employeeRepository.save(employee1);
    ...
    @Test
    public void should_throw_EmployeeNotFoundException_when_update_given_invalid_employee_id_and_employeeUpdate_info() throws Exception {
        //given
        Employee employee1 = new Employee("David", 18, "male", 10000);
        employeeRepository.save(employee1);
        String employeeUpdateAsJson = "{\n" +
        ...
        //when
        //then
        mockMvc.perform(put("/employees/" + "5fc8829e3bf5ed6bcd35a290")
                .contentType(MediaType.APPLICATION_JSON)
                .content(employeeUpdateAsJson))
                .andExpect(status().isNotFound())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof EmployeeNotFoundException))
    ...
    @Test
    public void should_EmployeeNotFoundException_when_delete_given_invalid_employee_id() throws Exception {
        //given
        Employee employee = new Employee("David", 18, "male", 10000);
        employeeRepository.save(employee);
        ...
        //when
        //then
        mockMvc.perform(delete("/employees/" + "5fc8829e3bf5ed6bcd35a290"))
                .andExpect(status().isNotFound())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof EmployeeNotFoundException))
                .andExpect(result -> assertEquals("Employee Id does not exist", result.getResolvedException().getMessage()));
    }
